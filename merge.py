...
X_train, _ = load_by_name('X_full', 'Y_full')
...
for i in range(len(train_files)):
    ...
    '''
    X_train.append(np.array(res1)/255.)
    X_train.append(np.array(res2)/255.)
X_train = np.array(X_google_test)
#del X_google_train
#np.save("X_10k", X_train)
print(X_train.shape)
